//! Steklo Assistant configuration management.
//!
//! This module handles the configuration file for Steklo's built-in AI assistant,
//! including default values, file paths, and ensuring required configuration keys exist.
//!
//! The configuration is stored in `assistant.toml` in the user's Steklo config directory.
...
///
/// The file is located in the same directory as the user's Steklo config,
/// typically `~/.config/steklo/assistant.toml` on macOS/Linux.
///
/// # Errors
...
pub fn default_assistant_toml_template() -> String {
    format!(
        "# Steklo Assistant configuration\n\
