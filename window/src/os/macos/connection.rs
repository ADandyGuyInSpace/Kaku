...
const STEKLO_BUNDLE_IDENTIFIER: &str = "fun.tw93.steklo";
...
impl ConnectionOps for Connection {
    ...
    fn set_default_terminal(&self) -> anyhow::Result<()> {
        let bundle_id = CFString::new(STEKLO_BUNDLE_IDENTIFIER);

        // Match the shell-related document types Steklo declares in Info.plist.
...
fn steklo_is_default_terminal() -> bool {
    ...
    handler_str.to_string() == STEKLO_BUNDLE_IDENTIFIER
}
